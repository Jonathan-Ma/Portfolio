    ...
    <html lang="en">
      <body className={`${inter.className} bg-black text-blue-50 h-[5000px]`}>
        <div className="relative min-h-screen flex -z-[100]">
          <div className="absolute inset-0 bg-cover" style={{ backgroundImage: "url('/B33LRGB_fb.png')", backgroundPosition: "center-right", backgroundAttachment: "fixed", backgroundSize: "cover", backgroundRepeat: "no-repeat"}}
          ></div>
