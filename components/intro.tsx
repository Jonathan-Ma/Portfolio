...
export default function Intro() {
    return (
        <div className='flex text-center h-screen items-center'>
            <section>
                <motion.p className='flex flex-wrap sm:w-[40rem] sm:text-2xl font-medium pt-[1rem] justify-center' initial={{ opacity: 0, scale: 0 }} animate={{ opacity: 1, scale: 1 }} transition={{ type: "spring", damping: 10, duration: 0.2, delay: 0.7 }}>
